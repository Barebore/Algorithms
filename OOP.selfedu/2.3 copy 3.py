class Bag:
    ...
    def add_thing(self, thing):
        if self.get_total_weight() + thing.weight < self.max_weigt:
            self.__things.append(thing)

    def remove_thing(self, thing):
        del self.things[self.things.index(thing)]
...
# "в классе Bag отсутствует объект-свойство things"
...
add_thing(self, thing) - добавление нового предмета в рюкзак (добавление возможно, если суммарный вес (max_weight) не будет
 превышен, иначе добавление не происходит);
